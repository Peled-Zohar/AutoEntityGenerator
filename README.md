...
&nbsp;&nbsp; Alternatively, you can install the extension by downloading the `.vsix` file from the [releases page](https://github.com/Peled-Zohar/AutoEntityGenerator/releases/tag/1.1.1).  
